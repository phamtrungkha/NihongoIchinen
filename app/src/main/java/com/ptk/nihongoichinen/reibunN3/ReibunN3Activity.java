...
public class ReibunN3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reibun_n3);

        listView = (ListView) findViewById(R.id.reibunN3_lv1);
        tocDo = (EditText) ReibunN3Activity.this.findViewById(R.id.reibunN3_tocdo);
        tocDo.setText("1");
        ...
        Button button = (Button) findViewById(R.id.reibunN3_next);
        button.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Intent intent = new Intent(ReibunN3Activity.this, ReibunLearnN3Activity.class);
                intent.putExtra("tocDo", tocDo.getText().toString());
                intent.putExtra("bai", bai);
                ReibunN3Activity.this.startActivity(intent);
            }
        });
    }
